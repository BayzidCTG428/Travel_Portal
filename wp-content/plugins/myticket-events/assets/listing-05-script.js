...
jQuery(function ($) {
	...
	function toggleZoneReservation(z, hall, p, t){
		...
		// reserve	
			...
			var ticket_obj = {zone_id: z, zone_text: zone_text, ticket_id: ticket_id, ticket_text: ticket_text + (t ? ' ('+t+') ':''), ticket_row: ticket_row, ticket_price: ticket_price, cfs: hall.cfs, type: "pass" };
	...
	function doSeatSelection(hall, ticket_id, z, s, p, t){
		...
		if(!$("#c"+ticket_id).hasClass("reserved")){
			...
			// structure ticket object 
			var ticket_obj = {zone_id: z, zone_text: zone_text, ticket_id: ticket_id, ticket_text: ticket_text + (t ? ' ('+t+') ':''), ticket_row: ticket_row, ticket_price: ticket_price, cfs: hall.cfs, type: "seat" };
